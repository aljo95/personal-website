<template>
    ...
    <div id="main-content">
        ...
        <div id="title-container-two">
            <h2 id="second">Software Engineer & Full Stack Developer</h2>
        </div>
...
#first {
    ...
    white-space: nowrap;
    overflow: hidden;
    animation: typing 3s steps(20, end) forwards, blink 1s 3.75;
    opacity: 0;
} 
...
#second {
    ...
    white-space: nowrap;
    overflow: hidden;
    animation: typingLong 3s steps(40, end) forwards, blink 1s 4;
